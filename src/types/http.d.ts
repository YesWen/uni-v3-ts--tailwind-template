...
export type HttpResponse<T = any> = HttpSuccess<T> | HttpError<T> | HttpDownloadResponse | HttpUploadResponse<T>;
type HttpPromise<T> = Promise<HttpResponse<T>>;
type Tasks = UniApp.RequestTask | UniApp.UploadTask | UniApp.DownloadTask;
type Method = "GET" | "POST" | "PUT" | "DELETE" | "CONNECT" | "HEAD" | "OPTIONS" | "TRACE" | "UPLOAD" | "DOWNLOAD";
...
export type InterceptorsRequest = HttpInterceptorManager<InterceptorsRequestConfig, InterceptorsRequestConfig>;
