 ...
 */
import { provide, getCurrentInstance, computed, watchEffect, ref, watch, onBeforeMount, ComponentInternalInstance } from "vue";
...
const { safeArea, windowWidth, windowHeight, statusBarHeight, windowTop } = uni.getSystemInfoSync();
